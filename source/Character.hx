...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-fun':
				var tex = Paths.getSparrowAtlas('characters/BOYFRIEND - copia', 'shared');
				frames = tex;
			...
			case 'sonic':
				...
				tex = Paths.getSparrowAtlas('characters/round2');
				frames = tex;
				animation.addByPrefix('idle', 'exe idle', 21);
				animation.addByPrefix('singUP', 'exe up', 21);
				animation.addByPrefix('singRIGHT', 'exe right', 21);
				animation.addByPrefix('singDOWN', 'exe down', 21);
				animation.addByPrefix('singLEFT', 'exe left', 21);
			...
			case 'exe':
				...
				frames = Paths.getSparrowAtlas('characters/round2');
